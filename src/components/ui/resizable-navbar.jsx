  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "border-2 border-blue-500/50 dark:bg-neutral-950/80",
        className
      )}
    >
      {children}
    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <span className="relative z-20 text-white    transition">
            {item.name}
          </span>
        </a>
      ))}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "border-2 border-blue-500/50  ",
        className
      )}
    >
      {children}
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md bg-white button bg-linear-to-r from-blue-600 to-cyan-600 text-white text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
